...
//   const limit = 1; // Nombre de cours par page
...
//             setCurrentPage(1); // Réinitialise à la première page après recherche
//           }}
//           className="w-full md:w-1/2 p-3 mb-8 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
//         />
